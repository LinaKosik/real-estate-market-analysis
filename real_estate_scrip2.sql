...
-- Дата: 11.04.2025 (правки от 13.04)

-- Комментарий: Добрый день! Спасибо большое за ревью! Постаралась учесть комментарии относительно доли снятых 
-- объявлений. По итоговым значениям удалось вывести долю близкую к тем, которые результируют у тебя. Надеюсь,
-- я все поняла правильно, потому что глаза уже замылились на этом третьем задании.
